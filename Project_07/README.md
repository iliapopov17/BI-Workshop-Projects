...
-	Porphyromonas gingivalis: known for its virulence factors, P. gingivalis plays a central role in periodontitis progression.
-	Tannerella forsythia: contributes to tissue destruction and inflammation in periodontal disease.
-	Treponema denticola: associated with subgingival plaque and periodontitis pathogenesis.
...
-	A precomputed assembly for the _Tannerella forsythia_ 92A2 genome specific to the G12 individual was obtained.
...
-	Basic statistics of the resulting alignment were obtained using the `samtools` flagstat command.
